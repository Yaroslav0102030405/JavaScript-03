...
// Задача Вывести в консоль все элементы этого массива не через консоль тейбл а по элементно
...
// Задача
// Перебрать маасив и добавить к тоталу 10%
// const cart = [54, 28, 105, 70, 92, 17, 120];
// // let total = 0;
// for (let i = 0; i < cart.length; i += 1) {
...
// Как улучшить код ятобы лучше читалось
// for (let i = 0; i < numbers.length; i += 1) {
...
// Задача
// Напиши скрпит который подсчитывает сумму всех нечетрных чисел в массиве
// const numbers = [1, 5, 8, 9, 12, 4, 15, 27, 30, 18, 14];
// let total = 0;
...
// Напишите скрпит который обьединяет все элементы массива в одно строковое значение
...
// Задача
// Напиши скрипт который который считает сумму элементов двух массивов
